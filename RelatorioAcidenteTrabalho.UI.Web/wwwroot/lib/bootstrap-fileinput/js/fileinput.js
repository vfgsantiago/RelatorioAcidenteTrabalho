...
(function (factory) {
  ...
  FileInput.prototype = {
    ...
    _initTemplateDefaults: function () {
      ...
      tPreview =
        ...
        "    </div>\n" +
        '    <div class="file-preview-status text-center text-gray"></div>\n' +
      ...
      self.defaults = {
        ...
        fileActionSettings: {
          ...
          rotateIcon: '<i class="fa fa-sync"></i>',
          ...
          dragSettings: {},
          indicatorNew: '<i class="fa fa- fa-lg text-warning"></i>',
          indicatorSuccess: '<i class="fa fa-check fa-lg text-success"></i>',
          indicatorError: '<i class="fa fa-exclamation fa-lg text-danger"></i>',
  ...
  $.fn.fileinput.defaults = {
    ...
    previewZoomButtonIcons: {
      ...
      rotate: '<i class="fa fa-sync"></i>',
      toggleheader: '<i class="fa fa-expand-arrows-alt"></i>',
        fullscreen: '<i class="fa fa-expand"></i>',
        borderless: '<i class="fa fa-border-none"></i>',
        close: '<i class="fa fa-window-close fa-lg"></i>',
    },
    ...
    customLayoutTags: {},
    customPreviewTags: {},
      previewFileIcon: '<i class="fa fa-file-word"></i>',
